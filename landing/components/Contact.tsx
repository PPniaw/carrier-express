  ...
  return(
    <Container as="main" contact={{ '@initial': 'mobile', '@m768': 'tablet', '@m1200': 'desktop' }}>
      ...
      <Section contactsection="privacy">
        ...
        <Paragraph>
          此專案透過 <Link href="https://splitbee.io" passHref><ParagraphLink rel="noopener" target="_blank">Splitbee</ParagraphLink></Link> 進行設計研究，以及參考 <Link href="https://vercel.com/analytics" passHref><ParagraphLink rel="noopener" target="_blank">Vercel Analytics</ParagraphLink></Link> 追蹤您的瀏覽體驗。<br />記錄的資料不會被再利用或販售至第三方。
        </Paragraph>
      </Section>
